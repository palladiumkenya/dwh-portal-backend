...
export class GetKhisHTSPOSHandler
    ...
    async execute(query: GetKhisHTSPOSQuery): Promise<any> {
        let htsPOS = this.repository.createQueryBuilder('f').select(
            ...
            SUM ( Positive_10_14_M ) + SUM ( Positive_10_14_F ) + SUM ( Positive_15_19_M ) + SUM ( Positive_15_19_F ) adolecent,
            SUM ( Positive_10_14_M ) + SUM ( Positive_10_14_F ) + SUM ( Positive_15_19_M ) + SUM ( Positive_15_19_F ) + SUM ( Positive_20_24_M ) + SUM ( Positive_20_24_F ) + SUM ( Positive_25_Plus_M ) + SUM ( Positive_25_Plus_F ) adults,
        ...
        if (
            ...
            htsPOS = this.repository.createQueryBuilder('f').select(
                ...
                0 Positive_1_9,
                SUM ( Positive_10_14_F ) + SUM ( Positive_15_19_F ) adolecent,
                SUM ( Positive_10_14_F ) + SUM ( Positive_15_19_F ) + SUM ( Positive_20_24_F ) + SUM ( Positive_25_Plus_F ) adults,
                0 Positive_10_14_M,
                SUM ( Positive_10_14_F ) Positive_10_14_F,
                0 Positive_15_19_M,
                SUM ( Positive_15_19_F ) Positive_15_19_F,
            ...
            htsPOS = this.repository.createQueryBuilder('f').select(
                ...
                0 Positive_1_9,
                SUM ( Positive_10_14_M ) + SUM ( Positive_15_19_M ) adolecent,
                SUM ( Positive_10_14_M ) + SUM ( Positive_15_19_M ) + SUM ( Positive_20_24_M ) + SUM ( Positive_25_Plus_M ) adults,
                0 Positive_10_14_F,
                SUM ( Positive_10_14_M ) Positive_10_14_M,
                0 Positive_15_19_F,
                SUM ( Positive_15_19_M ) Positive_15_19_M,
        ...
        if (query.agency) {
            htsPOS.andWhere('Agency IN (:...agencies)', {
