...
import { GetKhisHTSTESTQuery } from '../impl/get-khis-htstest.query';

@QueryHandler(GetKhisHTSTESTQuery)
export class GetKhisHTSTESTHandler
    implements IQueryHandler<GetKhisHTSTESTQuery> {
    constructor(
        @InjectRepository(FactHtsDhis2, 'mssql')
        private readonly repository: Repository<FactHtsDhis2>,
    ) {}

    async execute(query: GetKhisHTSTESTQuery): Promise<any> {
        let htsPOS = this.repository.createQueryBuilder('f').select(
            ...
            SUM ( Tested_1_9 ) + SUM ( Tested_10_14_M ) + SUM ( Tested_10_14_F ) children,
            SUM ( Tested_10_14_M ) + SUM ( Tested_10_14_F ) + SUM ( Tested_15_19_M ) + SUM ( Tested_15_19_F ) adolescent,
            SUM ( Tested_15_19_M ) + SUM ( Tested_15_19_F ) + SUM ( Tested_20_24_M ) + SUM ( Tested_20_24_F ) + SUM ( Tested_25_Plus_M ) + SUM ( Tested_25_Plus_F ) adults,
        ...
        if (
            ...
            htsPOS = this.repository.createQueryBuilder('f').select(
                ...
                0 Tested_1_9,
                0 +  SUM ( Tested_10_14_F ) children,
                SUM ( Tested_10_14_F ) + SUM ( Tested_15_19_F ) adolescent,
                SUM ( Tested_15_19_F ) + SUM ( Tested_20_24_F ) + SUM ( Tested_25_Plus_F ) adults,
                0 Tested_10_14_M,
                SUM ( Tested_10_14_F ) Tested_10_14_F,
                0 Tested_15_19_M,
                SUM ( Tested_15_19_F ) Tested_15_19_F,
            ...
            htsPOS = this.repository.createQueryBuilder('f').select(
                ...
                0 Tested_1_9,
                0 +  SUM ( Tested_10_14_M ) children,
                SUM ( Tested_10_14_M ) + SUM ( Tested_15_19_M ) adolescent,
                SUM ( Tested_15_19_M ) + SUM ( Tested_20_24_M ) + SUM ( Tested_25_Plus_M ) adults,
                0 Tested_10_14_F,
                SUM ( Tested_10_14_M ) Tested_10_14_M,
                0 Tested_15_19_F,
                SUM ( Tested_15_19_M ) Tested_15_19_M,
