...
import { GetKhisHTSPOSByPartnerQuery } from '../impl/get-khis-htspos-by-partner.query';

@QueryHandler(GetKhisHTSPOSByPartnerQuery)
export class GetKhisHTSPOSByPartnerHandler
    implements IQueryHandler<GetKhisHTSPOSByPartnerQuery> {
    constructor(
