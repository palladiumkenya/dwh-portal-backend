...
import { GetKhisHTSPOSByFacilityQuery } from '../impl/get-khis-htspos-by-facility.query';

@QueryHandler(GetKhisHTSPOSByFacilityQuery)
export class GetKhisHTSPOSByFacilityHandler
    implements IQueryHandler<GetKhisHTSPOSByFacilityQuery> {
    constructor(
