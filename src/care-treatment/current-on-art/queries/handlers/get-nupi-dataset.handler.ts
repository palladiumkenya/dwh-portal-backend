    ...
    async execute(query: GetNupiDatasetQuery): Promise<any> {
        ...
        const nupiDataset = 
            ...
            select
                ...
                FacilitySummary.EMR,
                coalesce (FacilitySummary.FacilityType, FullSites.FacilityType) As FacilityType,
                ...
                sum (nupi_NotVerified) As '# MOH Central Registry NotVerified',
                coalesce(round(cast(sum(nupi_NotVerified) as float) / cast(sum(TXCurr_khis) as float), 2), 0) as '% MOH Central Registry NotVerified of KHIS TXCurr',
            ...
            group by
                ...
                FacilitySummary.EMR,
                coalesce (FacilitySummary.FacilityType, FullSites.FacilityType),
                FacilitySummary.County,
